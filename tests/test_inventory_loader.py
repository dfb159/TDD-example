...
from inventory_app.inventory import Inventory, InventoryLoader, InvalidFileFormat, InventorySerializer


def test__load_from_disk():
    """Loads an existing file in the correct format."""
    loader = InventoryLoader("tests/persistance/valid", InventorySerializer())
...
def test__load_wrong_from_disk():
    ...
    loader = InventoryLoader("tests/persistance/invalid", InventorySerializer())
...
def test__save_to_disk():
    ...
    loader = InventoryLoader("tests/tmp/save", InventorySerializer())
...
def test__disk_roundtrip():
    ...
    loader = InventoryLoader("tests/tmp/roundtrip", InventorySerializer())
    loader.save_inventory(inventory)
